...
{/*  */}
        ...
        <div className="bg-white p-4 flex flex-col items-center border-gray-300 border-1 rounded-lg">
                        ...
                        <h2 className="text-gray-700">Active Restaurants</h2>
                        <h1 className="font-bold text-2xl">2</h1>
                    </div>
                ...
                <div className="flex items-center justify-center gap-2 text-md w-1/2 bg-gray-200 py-1 px-1 rounded-md">
                    ...
                    className={`w-1/2 p-1 text-center rounded-md ${allRestaurantsActive == true ? 'text-blue-500 bg-white':'text-gray-600'}`}>All Restaurants (4)</div>
                    <div
                    onClick={()=>{setAllRestaurantsActive(false)}}
                    className={`w-1/2 p-1 text-center rounded-md ${allRestaurantsActive == false ? 'text-blue-500 bg-white':'text-gray-600'}`}>Pending Requests (2)</div>
                </div>

                <div>
                    {allRestaurantsActive ? <AllRestaurantList/>:<PendingRestaurantRequests/>}
                </div>
